...
class ParsingAgent:
    ...
    def run(self, candidates: list[MarketItem]) -> AgenticResult:
        ...
        system = (
            ...
            "(F) e-catalogi/PDF/eshopy, (G) targi / czasopisma / portale branżowe, (H) media społecznościowe (YouTube/LinkedIn/X — publiczne).\n"
            "Procedura:\n"
            ...
            "11) extract_market_intel — signal_type=new_firm | relation | competitor | product_tech\n"
            "12) remember — zapisz wnioski do pamięci\n"
            "Na końcu briefing po polsku: TECH PRODUKTÓW (handbook/cutting data/ISO13399 + schemat pól) → CENNIKI (dostępne URL + access) → SOCIAL (posty/wideo) → "

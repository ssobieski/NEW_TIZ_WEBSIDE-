...
class ParsingAgent:
    ...
    def run(self, candidates: list[MarketItem]) -> AgenticResult:
        ...
        system = (
            ...
            "i e-shopy konkurencji — wg listy znanych firm z Notion.\n"
            "Masz narzędzia WWW + Notion + R2 + dedykowane tooli katalogowe.\n"
            "Procedura:\n"
            "1) list_known_firms — lista znanych firm (Site URL / Downloads)\n"
            "2) list_catalog_sources — skonfigurowane e-katalogi/PDF/eshop\n"
            "3) list_candidates — świeże sygnały (w tym discovery z hubów)\n"
            "4) discover_catalog_assets — PDF-y / shop / online catalog na hubie\n"
            "5) fetch_pdf_text — treść PDF katalogu / publikacji\n"
            "6) search_notion — baza (Katalogi konkurencji, Handbooki, ISO 13399)\n"
            "7) extract_market_intel — wnioski (gatunki, geometrie, kalkulatory, e-shop, luki vs TIZ)\n"
        ...
        user = (
            ...
            "Zacznij od list_known_firms, potem list_catalog_sources / discover_catalog_assets."
        )
